...
var lf1 = a11 + a21 + b11 + b21 + c11 + c21 + d11 + d21;
var lf2 = a12 + a22 + b12 + b22 + c12 + c22 + d12 + d22;
var lf3 = a13 + a23 + b13 + b23 + c13 + c23 + d13 + d23;

subject to eq1: (a11 + a21)/lf1 <= 205/1322;
subject to eq2: (a12 + a22)/lf2 <= 205/1322;
subject to eq3: (a13 + a23)/lf3 <= 205/1322;

subject to eq4: (b11 + b21)/lf1 <= 369/1322;
subject to eq5: (b12 + b22)/lf2 <= 369/1322;
subject to eq6: (b13 + b23)/lf3 <= 369/1322;

subject to eq7: (c11 + c21)/lf1 <= 340/1322;
subject to eq8: (c12 + c22)/lf2 <= 340/1322;
subject to eq9: (c13 + c23)/lf3 <= 340/1322;

subject to eq10: (d11 + d21)/lf1 <= 408/1322;
subject to eq11: (d12 + d22)/lf2 <= 408/1322;
subject to eq12: (d13 + d23)/lf3 <= 408/1322;
